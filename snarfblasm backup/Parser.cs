...
//        /////// <summary>
//        /////// Parses code from a list of strings, each representing a line.
//        /////// (Useful with StreamReader.)
//        /////// </summary>
//        /////// <param name="lines"></param>
//        ////public void ParseCode(IEnumerable<string> lines) {
//        ////    assembly = Assembler.Assembly;

//        ////    Error error;
//        ////    int lineNum = 0;
//        ////    foreach(string line in lines){
//        ////        ParseLine(line,  lineNum, out error);
...
//                } else {
//                    // Todo: ensure 'symbol' is a valid label name
//                    if (!Assembler.RequireColonOnLabels && !parsedUncolonedLabel) {
//                        assembly.Labels.Add(new Label(symbol.ToString(), newInstructionIndex, iSourceLine));
//                        parsedUncolonedLabel = true;
//                        loopAgain = true;
//                    } else {
//                        error = new Error(ErrorCode.Unexpected_Text, Error.Msg_BadLine, iSourceLine);
...
//                assembly.Directives.Add(new ConditionalDirective(NextInstructionIndex, sourceLine, directiveName, line, out error));
//            } else if (StringEquals(directiveName, "ENUM", true)) {
//                assembly.Directives.Add(new EnumDirective(NextInstructionIndex, sourceLine, line));
//            } else if (StringEquals(directiveName, "ENDE", true) || StringEquals(directiveName, "ENDENUM", true)) {
//                if (line.IsNullOrEmpty) {
...
//            if (line.Length > 0) {
//                if (line[0] == '*') {
//                    // Todo: use helper methods on assembly class instead of directly accessing collections (i.e. Assembly.AddStarLabel can call anonlabels.AddStarLabel AND TagAnonLabel)
//                    assembly.AnonymousLabels.AddStarLabel(iSourceLine);
//                    assembly.TagAnonLabel(iInstruction, iSourceLine);
...
//            var labelName = line.Substring(0, iColon).Trim();
//            // Todo: should be able to validate via a 'parse symbol' func
//            if (labelName.Length == 0 || !char.IsLetter(labelName[0]))
//                return false;
...
//            assembly.Labels.Add(new Label(labelName.ToString(), iParsedLine, iSourceLine));
//            line = line.Substring(iColon + 1).TrimLeft();
