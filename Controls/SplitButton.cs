...
namespace Microsoft.Samples
{
    ...
    public class SplitButton : Button
    {
        ...
        PushButtonState GetVisualState {
            get {
        ...
        protected override void OnPaint(PaintEventArgs pevent) {
            ...
            if (State != PushButtonState.Pressed && IsDefault && !Application.RenderWithVisualStyles) {
                ...
                if (Image != null) {
                    if (Enabled) {
                        Rectangle ImageRect = new Rectangle(4, (Height - Image.Height) / 2, Image.Width, Image.Height);
                        ButtonRenderer.DrawButton(g, bounds, Image, ImageRect, Focused && DrawFocusRectangle, GetVisualState);
                    } else {
                        Rectangle ImageRect = new Rectangle(4, (Height - Image.Height) / 2, Image.Width, Image.Height);
                        ButtonRenderer.DrawButton(g, bounds, GetVisualState);
            ...
            if (!string.IsNullOrEmpty(this.Text)) {
                Rectangle textBounds = focusRect;
                if (Image != null) {
                    textBounds.X += (4 + Image.Width);
                    textBounds.Width -= (4 + Image.Width);
                }

                Color textColor = SystemColors.ControlText;
                if (!Enabled) textColor = SystemColors.GrayText;
                TextRenderer.DrawText(g, Text, Font, textBounds, textColor, formatFlags);
            ...
            if (State != PushButtonState.Pressed && Focused && DrawFocusRectangle) {
