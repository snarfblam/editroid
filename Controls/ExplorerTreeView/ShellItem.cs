    ...
    class ShellItem:IDisposable
    {
        ...
        public void Dispose() {
            ...
            if (m_shShellFolder != null) {
                if (m_shShellFolder == ShellItem.m_shRootShell) {
                    // If you release m_shRootShell you have also to update m_shRootShell and m_bHaveRootShell
                    m_shRootShell = null;
