...
namespace Editroid.Asm
{
    ...
    {
        // Addressing modes
        // -- = Implied, accumulator, or for branches, relative
        // IX = (Indirect, X)
        // IY = (Indirect), Y
        // ZP = zero page
        // IM = Immediate
        // AB = Absolute
        string[] opData = new string[]{
            "00 BRK --",
            "01 ORA IX",
            "02 --- --",
            "03 --- --",
...
new op(0x0A, "ASL", addressing.accumulator, 2, true, true ), 
...
new op(0x2A, "ROL", addressing.accumulator, 2, true, true ), 
...
new op(0x4A, "LSR", addressing.accumulator, 2, true, true ), 
...
new op(0x6A, "ROR", addressing.accumulator, 2, true, true ), 
