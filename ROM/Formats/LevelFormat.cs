...
namespace Editroid.ROM.Formats
{
    ...
    class ExpandoLevelFormat : LevelFormat
    {
        ...
        ////public int TotalStructureMemory {
        ////    get {
        ////        int endOfAvailableSpace = EndOfAvailStructMemory;
        ////        int startOfAvailableSpace = Level.Pointers_depracated.StructTableOffset;

        ////        return endOfAvailableSpace - startOfAvailableSpace;
        ////    }
        ////}
        ...
        ////    get {
        ////        int startOfAvailableSpace = Level.Pointers_depracated.StructTableOffset;
        ////        int endOfUsedSpace = FindEndOfUsedStructMemory();

        ////        return endOfUsedSpace - startOfAvailableSpace;
        ////    }
        ////}
